...
<canvas id="myChart" style="width:100%;max-width:600px"></canvas>
        <script>
        var xValues = ["test","Livres","Oeuvres d`arts","Bijoux","Objets de collection","Vetements","Electronique"];
        var yValues = [0,0,3800,0,0,0,3100];
  var barColors = [
                  "#b91d47",
                  "#00aba9",
                  "#2b5797",
        ...
        new Chart("myChart", {
          ...
          options: {
            title: {
              display: true,
              text: "Montant total de vente par categorie enchère"
            }
          }
        });
        </script>
